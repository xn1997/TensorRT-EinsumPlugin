...
void BuildOptions::parse(Arguments& arguments)
{
    ...
    getAndDelOption(arguments, "--enableSerialization", enableSerialization);
...
// clang-format off
    os << "=== Build Options ==="                                                                                       << std::endl <<
          ...
          "Enable serialization: " << boolToEnabled(options.enableSerialization)                                        << std::endl <<
...
// clang-format off
    os << "=== Build Options ==="                                                                                                            << std::endl <<
          ...
          "                                              tactic  ::= (+|-)lib"                                                               << std::endl <<
          "                                              lib     ::= \"cublas\"|\"cublasLt\"|\"cudnn\""                                      << std::endl <<
          ...
          "  --enableSerialization       Enable serialization via buildSerializedNetwork instead of deprecated buildEngineWithConfig."       << std::endl
          ;
// clang-format on
}
